CLASS zcl_ce_rap_agency_702 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF ZZ_TRAVEL_AGENCY_ES5841283FCAB-agencyid.
    TYPES t_business_data TYPE TABLE OF ZZ_TRAVEL_AGENCY_ES5841283FCAB.
...
CLASS zcl_ce_rap_agency_702 IMPLEMENTATION.
...
**********************************************************************
* hier wird auf das Service consumotion model verwiesen um zu proxyien

    service_consumption_name = to_upper( 'ZCL_CE_RAP_AGENCY_702' ).
